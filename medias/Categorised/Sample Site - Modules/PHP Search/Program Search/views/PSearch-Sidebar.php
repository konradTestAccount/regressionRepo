                    ...
                    <ul class="no-bullet">
                        ...
                        foreach ($categoryFilters as $key) {
                            if (isset($filters[$key]) && is_array($filters[$key])) :
                                foreach ($filters[$key] as $value) :?>
                                    <li class="filter-<?php echo $i++ ?>  small primary" role="button" data-t4-value="<?php echo strtolower($value) ?>" data-t4-filter="<?php echo $key ?>"><?php echo $value ?><span  class="remove"><i class="fa fa-times"></i></span></li>
                                    <?php
                                endforeach;
                        ...
                        foreach ($dateFilters as $key) {
                            if (isset($filters[$key])) :
                                $value = $filters[$key]; ?>
                                <li class="filter-<?php echo $i++ ?>  small primary" role="button"  data-t4-filter="<?php echo $key ?>"><?php echo date('m/d/Y', strtotime($value)); ?><span class="remove"><i class="fa fa-times"></i></span></li>
                                <?php
                            endif;
                        }
                        foreach ($rangeFilters as $key => $max) {
                            if (isset($filters[$key]) && $filters[$key]!== $max) :
                                $value = $filters[$key]; ?>
                                <li class="filter-<?php echo $i++ ?>  small primary" role="button"  data-t4-filter="<?php echo $key ?>"><?php echo '$'.$value; ?><span class="remove"><i class="fa fa-times"></i></span></li>
                                <?php
                            endif;
                        }
                        if (isset($filters['keywords'])) :
                            ?>
                                <li class="filter-<?php echo $i++ ?> small primary" role="button"  data-t4-filter="keywords">  <?php echo $filters['keywords'] ?><span class="remove"><i class="fa fa-times"></i></span></li>
                            <?php
                        endif; ?>
                    </ul>
                    <?php if ($i > 0) : ?>
                        <a href="index.php" class="button primary small clear-filters" role="button"  data-t4-ajax-link="true">Clear Filters <i class="fa fa-chevron-right"></i></a>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
    </div>
        ...
        <form method="get" action="<?php echo $mainLibraryUrl ?>">
            ...
            <?php 
                ...
                foreach ($search as $key => &$item) :
                    $subitem = explode($childSeparator, $item['value']);
